...
RCT_EXTERN_METHOD(processRemindersChanges:(NSString *)containerId changes: (NSArray *)changes resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
